...
*/
#define POWER_IP_CONFIGURE_CADDRN    (STD_ON)

/**
* @brief            Support for LockStep Mode.
*/
#define POWER_IP_LOCKSTEP_SUPPORT   (STD_ON)
...
/**
* @brief            Warm Reset is/isn't available(STD_ON/STD_OFF)
*/
...
*/
#define POWER_IP_MC_ME_COFB_SUPPORT                 (STD_OFF)

/**
* @brief            Support Mc_Me COFB (COFB regiter present).
*/
#define POWER_IP_RTU_LOCKSTEP_SUPPORTED             (STD_ON)

/**
* @brief            Number of Groups/Peripherals (General-Purpose Registers present)
*/
#define POWER_IP_PERIPHERAL_GROUPS_COUNT        7U
#define POWER_IP_PERIPHERALS_NO                 ((uint8)101U)

#define POWER_IP_DMACRC0_PCLT_INDEX         11U
#define POWER_IP_DMACRC1_PCLT_INDEX         12U
#define POWER_IP_DMACRC4_PCLT_INDEX         13U
#define POWER_IP_DMACRC5_PCLT_INDEX         14U
#define POWER_IP_DMAMUX0_PCLT_INDEX         15U
#define POWER_IP_DMAMUX1_PCLT_INDEX         16U
#define POWER_IP_DMAMUX4_PCLT_INDEX         17U
#define POWER_IP_DMAMUX5_PCLT_INDEX         18U
#define POWER_IP_NANO_PCLT_INDEX            69U
#define POWER_IP_PIT_0_PCLT_INDEX           70U
#define POWER_IP_PIT_1_PCLT_INDEX           71U
#define POWER_IP_PIT_4_PCLT_INDEX           72U
#define POWER_IP_PIT_5_PCLT_INDEX           73U
