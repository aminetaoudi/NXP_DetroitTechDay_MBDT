...
*
*/
#define PIT_GPT_IP_MODULE_SINGLE_INTERRUPT (STD_OFF)
 ...
 *
 */
#define PIT_GPT_IP_MODULE_SINGLE_AND_MULTIPLE_INTERRUPTS (STD_ON)
...
*
*/
#define PIT_IP_PECULIAR_INSTANCES (STD_ON)
