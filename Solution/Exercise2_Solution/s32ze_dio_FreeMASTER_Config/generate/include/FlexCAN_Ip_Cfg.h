...
#define FLEXCAN_IP_FEATURE_INSTANCE_4_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN5 */
#define FLEXCAN_IP_FEATURE_INSTANCE_5_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN6 */
#define FLEXCAN_IP_FEATURE_INSTANCE_6_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN7 */
#define FLEXCAN_IP_FEATURE_INSTANCE_7_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN8 */
#define FLEXCAN_IP_FEATURE_INSTANCE_8_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN9 */
#define FLEXCAN_IP_FEATURE_INSTANCE_9_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN10 */
#define FLEXCAN_IP_FEATURE_INSTANCE_10_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN11 */
#define FLEXCAN_IP_FEATURE_INSTANCE_11_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN12 */
#define FLEXCAN_IP_FEATURE_INSTANCE_12_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN13 */
#define FLEXCAN_IP_FEATURE_INSTANCE_13_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN14 */
#define FLEXCAN_IP_FEATURE_INSTANCE_14_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN15 */
#define FLEXCAN_IP_FEATURE_INSTANCE_15_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN16 */
#define FLEXCAN_IP_FEATURE_INSTANCE_16_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN17 */
#define FLEXCAN_IP_FEATURE_INSTANCE_17_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN18 */
#define FLEXCAN_IP_FEATURE_INSTANCE_18_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN19 */
#define FLEXCAN_IP_FEATURE_INSTANCE_19_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN20 */
#define FLEXCAN_IP_FEATURE_INSTANCE_20_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN21 */
#define FLEXCAN_IP_FEATURE_INSTANCE_21_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN22 */
#define FLEXCAN_IP_FEATURE_INSTANCE_22_MAX_MB_NUM    (128U)

/* @brief Maximum number of Message Buffers supported for payload size 8 for CAN23 */
#define FLEXCAN_IP_FEATURE_INSTANCE_23_MAX_MB_NUM    (128U)
...
#define FLEXCAN_IP_FEATURE_MAX_MB_NUM_ARRAY { \
                        ...
                        FLEXCAN_IP_FEATURE_INSTANCE_12_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_13_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_14_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_15_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_16_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_17_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_18_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_19_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_20_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_21_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_22_MAX_MB_NUM, \
                        FLEXCAN_IP_FEATURE_INSTANCE_23_MAX_MB_NUM \
}
...
/* @brief Time base source selection for Time stamp CAN Message */
    ...
    #define FLEXCAN_HRTIMERSRC_NETC_VALUE    (0U)
    #define FLEXCAN_HRTIMERSRC_GTM_TBU0_VALUE    (1U)
    #define FLEXCAN_HRTIMERSRC_GTM_TBU1_VALUE    (2U)
    #define FLEXCAN_HRTIMERSRC_STM0_VALUE    (3U)
