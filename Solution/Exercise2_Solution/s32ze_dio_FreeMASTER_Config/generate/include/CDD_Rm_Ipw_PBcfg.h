...
/* Checks against Can_Hub_Ip.h */
#if (RM_IPW_PBCFG_VENDOR_ID != RM_CAN_HUB_IP_VENDOR_ID)
    #error "CDD_Rm_Ipw_PBcfg.h and Can_Hub_Ip.h have different vendor ids"
#endif
#if ((RM_IPW_PBCFG_AR_RELEASE_MAJOR_VERSION    != RM_CAN_HUB_IP_AR_RELEASE_MAJOR_VERSION) || \
     (RM_IPW_PBCFG_AR_RELEASE_MINOR_VERSION    != RM_CAN_HUB_IP_AR_RELEASE_MINOR_VERSION) || \
     (RM_IPW_PBCFG_AR_RELEASE_REVISION_VERSION != RM_CAN_HUB_IP_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of CDD_Rm_Ipw_PBcfg.h and Can_Hub_Ip.h are different"
#endif
#if ((RM_IPW_PBCFG_SW_MAJOR_VERSION != RM_CAN_HUB_IP_SW_MAJOR_VERSION) || \
     (RM_IPW_PBCFG_SW_MINOR_VERSION != RM_CAN_HUB_IP_SW_MINOR_VERSION) || \
     (RM_IPW_PBCFG_SW_PATCH_VERSION != RM_CAN_HUB_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Rm_Ipw_PBcfg.h and Can_Hub_Ip.h are different"
#endif
/*==================================================================================================
