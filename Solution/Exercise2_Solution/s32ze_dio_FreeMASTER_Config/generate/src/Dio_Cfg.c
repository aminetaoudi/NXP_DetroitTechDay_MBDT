...
*/
const uint32 Dio_au32ChannelAEToPartitionMap[DIO_CHANNEL_PARTITION_AE_U16] =
{
    (uint32)0x0000000000000001,
    (uint32)0x0000000000000001,
    (uint32)0x0000000000000001,
...
const Dio_PortLevelType Dio_aAvailablePinsForWrite[DIO_NUM_PORTS_U16] =
{
    ...
    (Dio_PortLevelType)0x03FF,
    (Dio_PortLevelType)0x3C00,
...
const Dio_ConfigType Dio_Config =
{
    ...
    Dio_au32ChannelAEToPartitionMap,
