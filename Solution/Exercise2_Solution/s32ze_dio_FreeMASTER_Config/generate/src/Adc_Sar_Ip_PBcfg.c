...
const Adc_Sar_Ip_ConfigType AdcSarIpConfig_0 =
{
    ...
    { ADC_SAR_IP_DEF_SAMPLE_TIME, ADC_SAR_IP_DEF_SAMPLE_TIME }, /* SampleTimeArr */
#endif /* FEATURE_ADC_HAS_CONVERSION_TIMING */
#if FEATURE_ADC_HAS_PRESAMPLING
    (boolean)FALSE, /* BypassSampling */
    { ADC_SAR_IP_PRESAMPLE_VREFH, ADC_SAR_IP_PRESAMPLE_AVDD }, /* PresamplingSourceArr */
    ...
    { 0U, 0U }, /* ChanMaskNormal */
    { 0U, 0U }, /* ChanMaskInjected */
    1U, /* NumChannels */
...
#if FEATURE_ADC_HAS_PRESAMPLING
    (boolean)FALSE, /* BypassSampling */
    { ADC_SAR_IP_PRESAMPLE_DVDD, ADC_SAR_IP_PRESAMPLE_DVDD }, /* PresamplingSourceArr */
#endif /* FEATURE_ADC_HAS_PRESAMPLING */
    (boolean)FALSE, /* AutoClockOff */
    (boolean)TRUE, /* OverwriteEnable */
    ADC_SAR_IP_DATA_ALIGNED_RIGHT, /* DataAlign */
