...
*/
#define DIO_NUM_PORTS_U16               ((uint16)0x23U)
...
*/
#define DIO_PORT_PARTITION_U16          ((uint16)35U)
...
*/
    ...
    #define DIO_NUM_CHANNELS_U16            ((uint16)173U)
#endif
...
* @note           Used for channel validation.
*/
#define DIO_CHANNEL_PARTITION_U16            ((uint16)174U)

/**
* @brief The number of partition on the channel of SIUL2_AE.
*
* @note           Used for channel validation.
*/
#define DIO_CHANNEL_PARTITION_AE_U16         ((uint16)44U)
...
*/
#define DIO_NUM_SIUL2_INSTANCES_U8      ((uint8)6U)
...
#define DIO_SIUL2_3_U8        ((uint8)2)
#define DIO_SIUL2_4_U8        ((uint8)3)
#define DIO_SIUL2_5_U8        ((uint8)4)
#define DIO_SIUL2_AE_U8        ((uint8)5)
...
*
*/
#define DioConf_DioPort_DioPort_0  ((uint8)0x0aU)



/**
* @brief          Symbolic name for the channel RED_D12_LED.
*
*/
#define  DioConf_DioChannel_RED_D12_LED ((uint16)0x0089U)
...
typedef struct
{
    ...
    const uint32 * pau32Dio_ChannelAEToPartitionMap;      /**< @brief Pointer to channel to partition mapping of SIUL2_AE */
...
/**
* @brief Array containing list of mapping channel for partition of SIUL2_AE
*/
extern const uint32 Dio_au32ChannelAEToPartitionMap[DIO_CHANNEL_PARTITION_AE_U16];
