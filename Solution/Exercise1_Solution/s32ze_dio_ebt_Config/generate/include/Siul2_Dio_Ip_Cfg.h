...
#define SIUL2_VIRTWRAPPER_MULTIINSTANCE         (STD_ON)
...
#define SIUL2_DIO_IP_HAS_SIUL2_AE_INSTANCE
#define SIUL2_DIO_IP_MAX_MSCR_REGISTERS         ((uint16)(512U))
#define SIUL2_DIO_IP_MAX_SIUL2_AE_CHANNELS      ((uint16)(43U))
...
/** SIUL2_AE */
/** Peripheral DIO_PTAB base pointer. Pins start from PBA_00 to PBB_07 */
#define DIO_PTAB                           ((Siul2_Dio_Ip_GpioType *)(&(IP_SIUL2_AE->PGPDO0)))
/** Peripheral DIO_PTBCD base pointer. Pins start from PBB_08 to PBD_05 */
#define DIO_PTBCD                          ((Siul2_Dio_Ip_GpioType *)(&(IP_SIUL2_AE->PGPDO1)))
/** Peripheral DIO_PTDE base pointer. Pins start from PBD_06 to PBE_07 */
#define DIO_PTDE                           ((Siul2_Dio_Ip_GpioType *)(&(IP_SIUL2_AE->PGPDO2)))
