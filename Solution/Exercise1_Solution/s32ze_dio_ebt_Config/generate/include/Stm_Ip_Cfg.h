...
#define RTU0_STM_0_IP_INSTANCE_NUMBER    (3U)
/** Channels number instance RTU0_STM_1 */
#define RTU0_STM_1_IP_CHANNELS_NUMBER  (4U)
#define RTU0_STM_1_IP_EXISTS
#define RTU0_STM_1_IP_INSTANCE_NUMBER    (4U)
/** Channels number instance RTU0_STM_2 */
#define RTU0_STM_2_IP_CHANNELS_NUMBER  (4U)
#define RTU0_STM_2_IP_EXISTS
#define RTU0_STM_2_IP_INSTANCE_NUMBER    (5U)
/** Channels number instance RTU0_STM_3 */
#define RTU0_STM_3_IP_CHANNELS_NUMBER  (4U)
#define RTU0_STM_3_IP_EXISTS
#define RTU0_STM_3_IP_INSTANCE_NUMBER    (6U)
/** Channels number instance RTU1_STM_0 */
#define RTU1_STM_0_IP_CHANNELS_NUMBER  (4U)
#define RTU1_STM_0_IP_EXISTS
#define RTU1_STM_0_IP_INSTANCE_NUMBER    (7U)
/** Channels number instance RTU1_STM_1 */
#define RTU1_STM_1_IP_CHANNELS_NUMBER  (4U)
#define RTU1_STM_1_IP_EXISTS
#define RTU1_STM_1_IP_INSTANCE_NUMBER    (8U)
/** Channels number instance RTU1_STM_2 */
#define RTU1_STM_2_IP_CHANNELS_NUMBER  (4U)
#define RTU1_STM_2_IP_EXISTS
#define RTU1_STM_2_IP_INSTANCE_NUMBER    (9U)
/** Channels number instance RTU1_STM_3 */
#define RTU1_STM_3_IP_CHANNELS_NUMBER  (4U)
#define RTU1_STM_3_IP_EXISTS
#define RTU1_STM_3_IP_INSTANCE_NUMBER    (10U)
/** Channels number instance CE_STM_0 */
#define CE_STM_0_IP_CHANNELS_NUMBER  (4U)
#define CE_STM_0_IP_EXISTS
#define CE_STM_0_IP_INSTANCE_NUMBER    (0U)
/** Channels number instance CE_STM_1 */
#define CE_STM_1_IP_CHANNELS_NUMBER  (4U)
#define CE_STM_1_IP_EXISTS
#define CE_STM_1_IP_INSTANCE_NUMBER    (1U)
/** Channels number instance CE_STM_2 */
#define CE_STM_2_IP_CHANNELS_NUMBER  (4U)
#define CE_STM_2_IP_EXISTS
#define CE_STM_2_IP_INSTANCE_NUMBER    (2U)
/** Channels number instance SMU_STM_0 */
#define SMU_STM_0_IP_CHANNELS_NUMBER  (4U)
#define SMU_STM_0_IP_EXISTS
#define SMU_STM_0_IP_INSTANCE_NUMBER    (11U)
/** Channels number instance SMU_STM_2 */
