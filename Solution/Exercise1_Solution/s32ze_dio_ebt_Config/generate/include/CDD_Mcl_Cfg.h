...
/* Check if header file and Llc_Ip_Cfg.h file are of the same vendor */
#if (CDD_MCL_CFG_VENDOR_ID != LLC_IP_CFG_VENDOR_ID)
    #error "CDD_Mcl_Cfg.h and Llc_Ip_Cfg.h have different vendor ids"
#endif

/* Check if header file and Llc_Ip_Cfg.h file are of the same Autosar version */
#if ((CDD_MCL_CFG_AR_RELEASE_MAJOR_VERSION != LLC_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_MCL_CFG_AR_RELEASE_MINOR_VERSION != LLC_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (CDD_MCL_CFG_AR_RELEASE_REVISION_VERSION != LLC_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of CDD_Mcl_Cfg.h and Llc_Ip_Cfg.h are different"
#endif

/* Check if header file and Llc_Ip_Cfg.h file are of the same Software version */
#if ((CDD_MCL_CFG_SW_MAJOR_VERSION != LLC_IP_CFG_SW_MAJOR_VERSION) || \
     (CDD_MCL_CFG_SW_MINOR_VERSION != LLC_IP_CFG_SW_MINOR_VERSION) || \
     (CDD_MCL_CFG_SW_PATCH_VERSION != LLC_IP_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Mcl_Cfg.h and Llc_Ip_Cfg.h are different"
#endif

/* Check if header file and Spfu_Ip_Cfg.h file are of the same vendor */
#if (CDD_MCL_CFG_VENDOR_ID != SPFU_IP_CFG_VENDOR_ID)
    #error "CDD_Mcl_Cfg.h and Spfu_Ip_Cfg.h have different vendor ids"
#endif

/* Check if header file and Spfu_Ip_Cfg.h file are of the same Autosar version */
#if ((CDD_MCL_CFG_AR_RELEASE_MAJOR_VERSION != SPFU_IP_CFG_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_MCL_CFG_AR_RELEASE_MINOR_VERSION != SPFU_IP_CFG_AR_RELEASE_MINOR_VERSION) || \
     (CDD_MCL_CFG_AR_RELEASE_REVISION_VERSION != SPFU_IP_CFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of CDD_Mcl_Cfg.h and Spfu_Ip_Cfg.h are different"
#endif

/* Check if header file and Spfu_Ip_Cfg.h file are of the same Software version */
#if ((CDD_MCL_CFG_SW_MAJOR_VERSION != SPFU_IP_CFG_SW_MAJOR_VERSION) || \
     (CDD_MCL_CFG_SW_MINOR_VERSION != SPFU_IP_CFG_SW_MINOR_VERSION) || \
     (CDD_MCL_CFG_SW_PATCH_VERSION != SPFU_IP_CFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of CDD_Mcl_Cfg.h and Spfu_Ip_Cfg.h are different"
#endif
