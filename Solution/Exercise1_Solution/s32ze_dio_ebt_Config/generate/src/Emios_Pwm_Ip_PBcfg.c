...
#define EMIOS_PWM_IP_PB_CFG_SW_MAJOR_VERSION_C                2
...
/* Emios PWM mode configuration structure for PwmEmios_1/PwmEmiosChannels_16 */
const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I1_Ch16 =
{
    /* .ChannelId */            16U,
...
const Emios_Pwm_Ip_ChannelConfigType Emios_Pwm_Ip_I1_Ch19 =
{
    /* .ChannelId */            19U,
    /* .Mode */                 EMIOS_PWM_IP_MODE_OPWMB_FLAG,
    /* .Timebase */             EMIOS_PWM_IP_BUS_A,
