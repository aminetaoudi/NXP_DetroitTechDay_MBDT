...
extern void MBDT_Can0_FifoOverflowNotif(void);
...
{
    /* CanHardwareObject: EXTENDED filter for FLEXCAN_0 with scheme type MASK_FILTER_SCHEME*/
    {
        (uint32)0x000003f0U,
        (uint32)0x1fffffffU
    },
